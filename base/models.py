...
class News(models.Model):
    ...
    fpict = models.ImageField(null=True, blank=True, default="DSC_1969.jpg")
...
class Junior(models.Model):
    ...
    NAME = models.CharField(max_length=200)
    MATHEMATICS = models.IntegerField(null=True, blank=True)
    ENGLISHSTUDIES = models.IntegerField(null=True, blank=True)
    BASICSCIENCEANDTECHNOLOGY = models.IntegerField(null=True, blank=True)
    PREVOCATIONALSTUDIES = models.IntegerField(null=True, blank=True)
    NATIONALVALUES = models.IntegerField(null=True, blank=True)
    CULTURALANDCREATIVEARTS = models.IntegerField(null=True, blank=True)
    HISTORY = models.IntegerField(null=True, blank=True)
    ISLAMICRELIGIOUSSTUDIES = models.IntegerField(null=True, blank=True)
